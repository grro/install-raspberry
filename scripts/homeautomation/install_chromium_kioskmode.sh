...
then
    ...
    sudo mkdir /etc/openhab/exec
    sudo mv start_browser.sh.tmp /etc/openhab/exec/start_browser.sh
    sudo chmod +x /etc/openhab/exec/start_browser.sh
    ...
    echo '@/etc/openhab/exec/start_browser.sh' >> autostart_extension.tmp
